# HeatGen ( will be updated in a few days)
...
![Alt text](assets/WorldModel.jpeg)

* Optimized 3D heat sink 1
![Alt text](assets/OptimizedHeatsink1.png)

* Optimized 3D heat sink 2
![Alt text](assets/OptiizedHeatsink2.png)

* t-SNE of the guided diffusion model
![Alt text](assets/GuidedTsne.png)
